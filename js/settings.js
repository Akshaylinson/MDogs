    ...
    <div style="max-width:1280px;margin:0 auto;padding:24px 20px 40px;">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:32px;padding:8px 0 24px;border-bottom:1px solid #e0e0e0;margin-bottom:24px;">
        ...
        <div>
          ...
          <div style="font-size:28px;font-weight:700;color:#212121;margin-top:2px;">${media.length}</div>
        </div>
        <div>
        ...
        <div>
          ...
          <div style="font-size:28px;font-weight:700;color:#212121;margin-top:2px;">${formatBytes(storageBytes)}</div>
        </div>
      </div>

      <!-- Page title -->
      <div style="margin-bottom:20px;">
        <div style="font-size:20px;font-weight:700;color:#212121;">Settings</div>
        <div style="font-size:13px;color:#888;margin-top:2px;">Manage appearance, slideshow, backup, and storage preferences</div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:16px;">
        ...
        <div class="fk-card" style="overflow:hidden;">
          <div style="background:#2874f0;padding:14px 18px;display:flex;align-items:center;gap:10px;">
            <svg width="18" height="18" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
            <span style="color:#fff;font-size:14px;font-weight:700;">Appearance</span>
          </div>
            ...
            <div>
              ...
              <div style="display:flex;gap:8px;">
                <button data-view="grid" style="flex:1;height:40px;border-radius:2px;font-size:13px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;
                  ${settings.galleryView !== "list" ? "background:#2874f0;color:#fff;border:none;" : "background:#fff;color:#555;border:1px solid #d0d0d0;"}">
        ...
        <div class="fk-card" style="overflow:hidden;">
          <div style="background:#2874f0;padding:14px 18px;display:flex;align-items:center;gap:10px;">
            ...
            <span style="color:#fff;font-size:14px;font-weight:700;">Slideshow</span>
          </div>
          <div style="padding:18px;display:flex;flex-direction:column;gap:16px;">
            <div>
            ...
            <hr class="fk-divider" />
            <div style="background:#e8f0fe;border-radius:3px;padding:12px 14px;display:flex;gap:10px;align-items:flex-start;">
              <svg width="16" height="16" fill="none" stroke="#2874f0" stroke-width="2" viewBox="0 0 24 24" style="flex-shrink:0;margin-top:1px;"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
              <p style="font-size:12px;color:#1a5dc8;line-height:1.5;">Use <strong>Space</strong> to pause, <strong>← →</strong> to navigate, and <strong>Esc</strong> to close the slideshow.</p>
            </div>
          </div>
        </div>
        ...
        <div class="fk-card" style="overflow:hidden;">
          <div style="background:#2874f0;padding:14px 18px;display:flex;align-items:center;gap:10px;">
            <svg width="18" height="18" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
            <span style="color:#fff;font-size:14px;font-weight:700;">Backup &amp; Restore</span>
          </div>
          <div style="padding:18px;display:flex;flex-direction:column;gap:12px;">
            <p style="font-size:13px;color:#555;line-height:1.6;">Export your categories, tags, and settings as a JSON file. Media blobs are not included — only metadata.</p>
            ...
            <hr class="fk-divider" />
            <p style="font-size:13px;color:#555;line-height:1.6;">Restore from a previously exported JSON file. This will overwrite all current data.</p>
        ...
        <div class="fk-card" style="overflow:hidden;">
          <div style="background:#e53935;padding:14px 18px;display:flex;align-items:center;gap:10px;">
            ...
            <span style="color:#fff;font-size:14px;font-weight:700;">Danger Zone</span>
          </div>
          <div style="padding:18px;display:flex;flex-direction:column;gap:12px;">
            <div style="background:#fff5f5;border:1px solid #ffcdd2;border-radius:3px;padding:12px 14px;">
              <p style="font-size:13px;color:#c62828;font-weight:600;margin-bottom:4px;">Clear all data</p>
              <p style="font-size:12px;color:#e57373;line-height:1.5;">This permanently deletes all categories, media, tags, and settings stored in IndexedDB. This action cannot be undone.</p>
            </div>
  ...
  app.addEventListener("click", async (e) => {
    ...
    if (btn.dataset.view) {
      ...
      app.querySelectorAll("[data-view]").forEach((b) => {
        ...
        b.style.background = active ? "#2874f0" : "#fff";
        b.style.color = active ? "#fff" : "#555";
        b.style.border = active ? "none" : "1px solid #d0d0d0";
      });
      return;
    }
